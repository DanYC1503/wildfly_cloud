...
a persistence unit "Cloud_projectPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Cloud_project/pom.xml":
...
artifact ("Cloud_project.war") is already built. You can build
